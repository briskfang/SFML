...
Sprite branches[NUM_BRANCHES]; //how to implement the construct to support this?
...
int main()
{
    ...
    spriteCloud3.setPosition(1100, 100);
    ...
    float timeBarWithPerSecond = timeBarStartWidth / timeRemaining ;
    ...
    while (window.isOpen())
    {
        ...
        if(!paused)
        {
            ...
            timeBar.setSize(Vector2f(timeBarWithPerSecond * timeRemaining, timeBarHeight));
